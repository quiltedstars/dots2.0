...
local DIR = os.getenv("HOME") .. "/.config/awesome/ui/bar/modules/pacman-widget/"
...
config.polkit_agent_path = "/usr/bin/lxqt-policykit-agent"
...
local function worker(user_args)
    ...
    timer = select(2, awful.widget.watch([[bash -c "xbps-install -Mun 2> /dev/null | wc -l"]],
        _config.interval,
